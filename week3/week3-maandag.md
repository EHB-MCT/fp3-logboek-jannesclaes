...
- De dag gestart met een reflectie te maken over de feedback van vorige week
- Het scrum board aangevuld
- mail gestuurd naar Paul voor zijn schets
- geprobeerd om adibe firefly API aan de praat te krijgen om te kunnen gebruiken om images te genereren
- op zoek gegaan naar andere mogelijkheden in verband met images generating API's
- veel gediscusieerd in verband met design keuzes
- gesukkeld met open Ai en hun image generating api functie
...
> - Of: Ik heb geleerd hoe ik mijn teamgenoten kan motiveren als ze vastlopen.
  ...
  - open AI dall-e 3 toevoegen in de front end
  - 
...
- Heel veel werk te doen, niet gestructereerd meer en heb twijfels over het eind resultaat
- **"verward"**
